pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'ayhm23/imt2023128-calculator'
        
        // The ID you created in Jenkins
        REGISTRY_CREDENTIALS = 'dockerCreds'
    }
    ...
    stages {
        ...
        stage('Run Tests') {
            steps {
                ...
                // Compiles the main application to check for syntax errors
        ...
        stage('Push to Docker Hub') {
            steps {
                script {
                    ...
                    // Uses 'dockerCreds' to securely inject User/Pass
